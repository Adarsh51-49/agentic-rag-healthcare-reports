...
privately. A reviewer should place private archives outside the repository and
upload the expected file only when a Colab notebook requests it.

The live demonstration creates a separate run. It must not be added to or confused
with the frozen 45-report formal experiment.
